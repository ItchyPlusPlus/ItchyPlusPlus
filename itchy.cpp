...
{
    QMessageBox::information(NULL, "Itchy++ | Open Scratch Project", "Feature not implemented yet!");
}

void itchy::on_actionItchy_Project_triggered()
{
    QMessageBox::information(NULL, "Itchy++ | Open Itchy Project", "Feature not implemented yet!");
}

void itchy::on_actionHelp_triggered()
{
    QMessageBox::information(NULL, "Itchy++ | Help", "Feature not implemented yet!");
}
